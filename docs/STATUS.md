...
- 2026-04-28 新增十个 focused app tests，继续补稳 `TestNodes` 无启用节点输出、节点改名后规则/ACL 目标联动，以及 `deployMenu`、`nodesMenu`、`subscriptionsMenu`、`networkMenu`、`serviceMenu`、`auditMenu` 的关键分发路径；当前 `internal/app` 包覆盖率已提升到 90.3%。
