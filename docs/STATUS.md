...
- 本轮验证结果：focused `go test ./internal/app -run 'Test(RemoveNodeRejectsSubscriptionNode|RenameNodeRejectsSubscriptionNode|SetNodeEnabledUpdatesManualNodesAndRejectsSubscriptionNodes|ListNodesAndRemoveNodePersistUpdatedState)'` 与全量 `go test ./...` 通过。
