...
- 本轮验证结果：focused `go test ./internal/app -run 'TestRemoveSubscription(DeletesCacheAndNodes|IgnoresMissingCache|ReturnsCacheRemovalFailure)'` 与全量 `go test ./...` 通过。
