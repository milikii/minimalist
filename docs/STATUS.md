...
- 当前主线已进入阶段 5，已完成第五十五刀：`cleanup_project_install_tree_metadata` 的 Python 缓存清理已抽到共用 helper。
...
- `cleanup_project_install_tree_metadata` 的备份垃圾清理仍内联在主函数中，阶段 5 后续可继续收口
