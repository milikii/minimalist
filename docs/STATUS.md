...
- 当前 Go 测试已覆盖配置、provider、rules-repo、核心 app 路径、top-level CLI、主要 CLI helper、runtime 文本生成和 system runner，但 `runtime` / `cli` 测试中仍有少量可继续合并的重复场景
